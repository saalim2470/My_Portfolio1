...
export default function Contact() {
    ...
    try {
      if (formRef.current) {
        const result = await emailjs.sendForm(
          'service_qtaeys8', // Your EmailJS service ID (already set)
          'template_8qxy6y8', // Replace with your template ID from EmailJS dashboard
          formRef.current,
          'jeoU_vLay-zcX8BZp' // Replace with your public key from EmailJS dashboard (Account > API Keys)
        );
  ...
  return (
    <>
      <Head>
        <title>Contact | Piyush Chauhan Portfolio</title>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">piyushchauhan936001@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">+91 9998612186</p>
                    </div>
                  </div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    <a href="https://github.com/PiyushChauhan3" target="_blank" rel="noopener noreferrer" className="bg-gray-800 text-white p-3 rounded-full hover:bg-gray-700 transition duration-300">
                    ...
                    <a href="https://www.linkedin.com/in/piyushchauhan30/" target="_blank" rel="noopener noreferrer" className="bg-blue-700 text-white p-3 rounded-full hover:bg-blue-600 transition duration-300">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/>
                      </svg>
                    </a>
                    <a href="https://instagram.com/piyush___chauhan_" target="_blank" rel="noopener noreferrer" className="bg-blue-400 text-white p-3 rounded-full hover:bg-blue-500 transition duration-300">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
